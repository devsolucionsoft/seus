<template>
    <div class="page-container">
        <nav>
            <router-link to="/empresas" class="element">
                <img src="@/assets/icons/company.svg" alt="Companies Icon">Empresas
            </router-link>

            <router-link to="/personas" class="element">
        ...
        <footer>
            <div class="marcas">
                <img src="@/assets/marcas/cocacola.png" alt="Coca Cola">
                <img src="@/assets/marcas/bancolombia.png" alt="Bancolombia">
                <img src="@/assets/marcas/nutresa.png" alt="Nutresa">
                <img src="@/assets/marcas/velez.png" alt="Velez">
                <img src="@/assets/marcas/cocacola.png" alt="Coca Cola">
                <img src="@/assets/marcas/bancolombia.png" alt="Bancolombia">
                <img src="@/assets/marcas/nutresa.png" alt="Nutresa">
                <img src="@/assets/marcas/velez.png" alt="Velez">
...
<style scoped>
    ...
    .page-container footer .marcas{
        display: flex;
        flex-direction: row;
        gap: 33px;
        align-self: flex-end;
    }
    .page-container footer .marcas img{
        max-height: 47px;
    }
